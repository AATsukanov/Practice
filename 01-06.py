...
Выведите на экран(в консоль) первый сивол этой строки.
Выведите на экран(в консоль) последний сивол этой строки (используя отрицательный индекс).
...
example = u'Тапинамбур'

print(example[0])
print(example[-1])
#example = 'Urban' #-- для проверки
